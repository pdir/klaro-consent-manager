...
namespace Pdir\ContaoKlaroConsentManager\Controller\FrontendModule;
...
/**
 * Class KlaroFeModuleController.
 *
 * @FrontendModule(KlaroFeModuleController::TYPE, category="pdir", template="mod_klaro_fe_module")
 */
class KlaroFeModuleController extends AbstractFrontendModuleController
{
    public const TYPE = 'klaro_fe_module';
