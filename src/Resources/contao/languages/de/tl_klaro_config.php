...
$GLOBALS['TL_LANG']['tl_klaro_config'] = [
    ...
    'acceptAll' => ['&raquo;Alle akzeptieren&laquo;', 'Wenn Sie diese Option aktivieren, wird im Overlay (Klaro-Manager) die Schaltfläche &raquo;Alle akzeptieren&laquo; angezeigt, über die Sie allen Diensten von Drittanbietern mit einem Klick zustimmen können. Wenn Sie diese Option deaktivieren, können Sie jedem Dienst einzeln zustimmen.'],
    'hideDeclineAll' => ['&raquo;Ich lehne ab&laquo; ausblenden', 'Wenn Sie diese Option aktivieren, wird die Schaltfläche &raquo;Ich lehne ab&laquo; im Overlay ausgeblendet und der Nutzer ist gezwungen, das Overlay gesondert zu öffnen, um seine Zustimmung zu ändern oder alle Drittanbieterdienste zu deaktivieren. Wir raten Ihnen dringend davon ab, diese Funktion zu verwenden, da sie den Grundsätzen &raquo;privacy by default&laquo; und &raquo;privacy by design&laquo; der Datenschutz-Grundverordnung zuwiderläuft.'],
    ...
    'hideLearnMore' => ['&raquo;Lassen Sie mich wählen&laquo; ausblenden', 'Wenn Sie diese Option aktivieren, wird der Link &raquo;Lassen Sie mich wählen / anpassen&laquo; in der Einwilligungserklärung ausgeblendet. Wir raten dringend davon ab, dies zu tun, da es den Benutzer daran hindert, seine Einwilligungsentscheidungen anzupassen.'],
    // cookie legend
